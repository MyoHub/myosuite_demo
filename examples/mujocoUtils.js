...
export function setupGUI(parentContext) {
  ...
  parentContext.gui.add(parentContext.params, 'scene', {
    ...
    "Hand": "myo_sim/hand/myo_hand_no_scene.xml",
...
export async function downloadExampleScenesFolder(mujoco) {
  let allFiles = [
    ...
    "myosuite/Geometry/ground_jaw.stl",
    ...
    "myosuite/Geometry/arm_r_pisiform.stl",
    "myosuite/Geometry/arm_r_triquetrum.stl",
    "myosuite/Geometry/arm_r_capitate.stl",
    "myosuite/Geometry/arm_r_trapezium.stl",
    "myosuite/Geometry/arm_r_trapezoid.stl",
    "myosuite/Geometry/arm_r_hamate.stl",
    "myosuite/Geometry/arm_r_1mc.stl",
    "myosuite/Geometry/arm_r_2mc.stl",
    "myosuite/Geometry/arm_r_3mc.stl",
    "myosuite/Geometry/arm_r_4mc.stl",
    "myosuite/Geometry/arm_r_5mc.stl",
    "myosuite/Geometry/arm_r_thumbprox.stl",
    "myosuite/Geometry/arm_r_thumbdist.stl",
    "myosuite/Geometry/arm_r_2proxph.stl",
    "myosuite/Geometry/arm_r_2midph.stl",
    "myosuite/Geometry/arm_r_2distph.stl",
    "myosuite/Geometry/arm_r_3proxph.stl",
    "myosuite/Geometry/arm_r_3midph.stl",
    "myosuite/Geometry/arm_r_3distph.stl",
    "myosuite/Geometry/arm_r_4proxph.stl",
    "myosuite/Geometry/arm_r_4midph.stl",
    "myosuite/Geometry/arm_r_4distph.stl",
    ...
    "myo_sim/meshes/full_body_skin.skn",
