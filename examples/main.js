...
mujoco.FS.writeFile("/working/myo_elbow_1dof6muscles.xml", await (await fetch("./examples/myosuite/myo_elbow_1dof6muscles.xml")).text());

// Load in the state from XML
let model       = new mujoco.Model("/working/myo_elbow_1dof6muscles.xml");
